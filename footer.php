					...
					<div class="row">
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<p>This is my Small Database Management System</p>
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Bangalore</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+91-9880411357</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>mitbusiness15@gmail.com</a></li>
								</ul>
							</div>
						</div>
